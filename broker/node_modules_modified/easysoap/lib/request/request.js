(function() {
    ...
    that.soapCall = function(callParams, soapParams, stdParams, opts) {
        ...
        return new Promise(function(stdParams) {
            return function (resolve, reject)
			{
				read(__dirname + path.sep + 'request.tpl', 'utf-8')
	                .then(function(tpl) {
						...
						stdParams.writeStream.write(_tpl+"\n");
						...
						{
							stdParams.writeStream.write("ERROR \n");
	                     ...
	                     request.once('response',  function(res) {
								...
								stdParams.writeStream.write('STATUS: ' + res.statusCode + "\n");
								stdParams.writeStream.write('HEADERS: ' + JSON.stringify(res.headers) + "\n");
								stdParams.writeStream.write("RESPONSE \n");
	                            ...
	                            res.setEncoding('utf8');
	                            res.on('end', function() {
									stdParams.writeStream.write(data + "\n");
									stdParams.writeStream.write("REQUEST END" + "\n");
	                            ...
	                            res.on('data', function(chunk) {
									stdParams.writeStream.write("REQUEST DATA" + "\n");
							...
							stdParams.writeStream.write("HEADER INFORMATION" + "\n");
							stdParams.writeStream.write(request);
							stdParams.writeStream.write("END HEADER INFORMATION" + "\n");
